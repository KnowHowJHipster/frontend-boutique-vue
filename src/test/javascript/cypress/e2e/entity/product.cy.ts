...
describe('Product e2e test', () => {
  ...
  const productSample = { name: 'infantile starve debut', price: 1372.75, productSize: 'XL' };
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      ...
      body: { name: 'bleakly', description: 'velvet daintily likely' },
    }).then(({ body }) => {
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      cy.get(`[data-cy="name"]`).type('hollow slacken');
      cy.get(`[data-cy="name"]`).should('have.value', 'hollow slacken');

      cy.get(`[data-cy="description"]`).type('on afore but');
      cy.get(`[data-cy="description"]`).should('have.value', 'on afore but');

      cy.get(`[data-cy="price"]`).type('1629.21');
      cy.get(`[data-cy="price"]`).should('have.value', '1629.21');
