...
describe('ProductCategory e2e test', () => {
  ...
  const productCategorySample = { name: 'lady' };
  ...
  describe('new ProductCategory page', () => {
    ...
    it('should create an instance of ProductCategory', () => {
      cy.get(`[data-cy="name"]`).type('fox');
      cy.get(`[data-cy="name"]`).should('have.value', 'fox');

      cy.get(`[data-cy="description"]`).type('remap ugh opposite');
      cy.get(`[data-cy="description"]`).should('have.value', 'remap ugh opposite');
